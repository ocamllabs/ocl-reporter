...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1becfe51c27a23c1a4d92142e968455c) *)
(*
...
# 104 "/Users/avsm/src/git/avsm/oasis/src/oasis/OASISTypes.ml"
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Anil Madhavapeddy"; "Leo White"; "Amir Chaudhry"];
          homepage = None;
          synopsis = "OCaml Labs report generator";
          description = None;
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "www.ml"; });
               Executable
                 ({
                     cs_name = "ocl-github-query";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "github_query.ml"; })
            ];
          plugins =
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "V@\028ªuy}ú=\140\148_N¹FÉ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
